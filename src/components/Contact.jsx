...
export default function Contact() {
  const [ref, isInView] = useInView({ rootMargin: '0px 0px -80px 0px' });

  return (
    <section id="contact" className="py-24 px-5 bg-[var(--bg)]">
      <div ref={ref} className={`max-w-2xl mx-auto text-center reveal ${isInView ? 'is-visible' : ''}`}>
        <p className="text-[var(--accent-muted)] text-sm font-medium tracking-widest uppercase mb-4">
          Get in touch
        </p>
        ...
        <a
          href="mailto:ritikatyagi514@gmail.com"
        ...
        <div className="flex justify-center gap-4 mt-8">
          <a
            href="https://github.com/Ritikatyagi1409"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/ritika-tyagi-3b5795257/"
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 rounded-xl text-[var(--text-muted)] hover:text-[var(--accent)] hover:bg-[var(--accent)]/10 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]/50"
            aria-label="LinkedIn"
